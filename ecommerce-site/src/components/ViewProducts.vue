<template>
 ...
 <div class="single-view-container">
    ...
    <div class="all-view-items-container">
      ...
      <SingleViewVue v-for="product in products?.products" :deleteProduct="deleteProduct"  :key="product?._id" :product="product"/>
...
const deleteProduct = (id) => {
  products.value.products= products.value?.products?.filter(product => product?._id !== id);
}
onMounted(() => {
  const fetch = async () => {
